...
from octotools.engine.gemini import ChatGemini
...
class Python_Code_Generator_Tool(BaseTool):
    ...
    def __init__(self, model_string="gemini-2.0-flash"):
        super().__init__(
        ...
        self.llm_engine = ChatGemini(model_string=model_string, is_multimodal=False) if model_string else None
...
if __name__ == "__main__":
    ...
    tool = Python_Code_Generator_Tool(model_string="gemini-2.0-flash")
